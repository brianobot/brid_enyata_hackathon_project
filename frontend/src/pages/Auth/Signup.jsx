...
export default function SignupPage() {
  ...
  return (
    ...
    <div className="flex flex-col">
        ...
        <button
            onClick={() => navigate('/')}
            className="group flex items-center gap-2 pt-10 pl-5 text-slate-400 hover:text-blue-900 mb-8 transition-colors text-sm font-bold"
          >
          ...
          <div className="w-full bg-white/70 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl px-10 py-10 transition-all duration-500">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-center text-sm text-slate-400 mt-2 font-medium">
                ...
                <Link to="/login" className="text-[#154470] font-bold hover:underline">
                  Login
                </Link>
              </p>
            </form>
